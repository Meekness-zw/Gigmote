              ...
              <>
                ...
                >
                  ...
                  <div className="relative px-6 pt-8 pb-8 overflow-y-auto">
                    ...
                    >
                      <Link href="/join-gigmote" onClick={handleClose} className="block w-full">
                        <Button
                          variant="outline"
                          size="lg"
                          className="w-full font-bold text-lg py-5 border-hugo-black/20 text-hugo-black hover:bg-hugo-black hover:text-white"
                        >
                          Join Gigmote
                        </Button>
                      </Link>
                      <Link href="/contact" onClick={handleClose} className="block w-full">
                        <Button
                          variant="primary"
                          size="lg"
