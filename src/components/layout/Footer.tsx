                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex items-center gap-2">
                            <input
                                ...
                                className="h-10 bg-white/10 border border-white/10 rounded-lg px-4 text-sm text-white placeholder:text-white/50 focus:outline-none focus:border-hugo-gold w-full"
                            />
                            <Button size="md" variant="secondary" className="shrink-0">Go</Button>
                        </div>
                    </div>
                </div>
